...
* The component has it's own folder, with the style and react code in it. The react code is named "index.tsx"
* The style of each component is kept in a separated file called "index.jss.ts"
* The style uses a theme
